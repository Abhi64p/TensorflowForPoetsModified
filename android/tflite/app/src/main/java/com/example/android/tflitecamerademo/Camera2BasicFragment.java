        ...
        try
        {
            if (manager != null)
                for (String cameraId : manager.getCameraIdList())
                {
                    ...
                    Integer tmp = characteristics.get(CameraCharacteristics.SENSOR_ORIENTATION);
                    int sensorOrientation = tmp == null ? 0 : tmp;
                    ...
                    int rotatedPreviewW = width;
                    int rotatedPreviewH = height;
                    int maxPreviewW = displaySize.x;
                    int maxPreviewH = displaySize.y;

                    if (swappedDimensions)
                    {
                        rotatedPreviewW = height;
                        rotatedPreviewH = width;
